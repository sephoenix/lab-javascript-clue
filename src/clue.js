...
function revealMystery() {
  return (`${mystery[0].firstName} ${mystery[0].lastName} killed Mr.Boddy using the ${mystery[2].name} in the ${mystery[1]}!`)
}
revealMystery()
